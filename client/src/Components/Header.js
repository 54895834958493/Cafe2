...
export default function Header() {
    ...
    const showLogin = <a href={!isAuth ? '/login' : '/account'}><img className="regis"src={regis}alt="Regis"/></a>;
    const changeModalStatus = () => isAuth ? dispatch(setCartOpen(!isOpen)) : alert('Чтобы воспользоваться корзиной - авторизуйтесь');
